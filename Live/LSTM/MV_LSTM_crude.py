...
class MV_LSTM_crude:
    ...
    def clt_LSTM_Model(self):
        ...
        FEATURES = ['High', 'Low', 'Open', 'Close', 'Volume', 'Crude Oil']
        ...
        #model.save('/Live/Models/MVLSTM_crude.h5')
        model.save(model_path+'\MVLSTM_crude.h5')
...
#-------------------------------------------------------
    ...
    def load_Test_Model(self):
        ...
        # Model Training
        #model = load_model('MVLSTM_crude.h5')
        model = load_model(model_path+'\MVLSTM_crude.h5')
        ...
        save = save[select]
        # print(save)
        #save.to_csv('C:/Users/Gomathinayagam/PycharmProjects/StockOverflowR2/Medium/LSTM_crude.csv',index=False)
        filename = os.path.join(rp.dirname, 'Medium/LSTM_crude.csv')
