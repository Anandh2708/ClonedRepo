...
#filename = os.path.join(rp.dirname, 'Live/Models')
#Live/Models
...
class MV_LSTM:
    ...
    def clt_LSTM_Model(self):
        ...
        self.data_filtered = self.data[self.FEATURES]
        ...
        #model.save('/Live/Models/MVLSTM.h5')
        model.save(model_path+'\MVLSTM.h5')
...
#-------------------------------------------------------
    ...
    def load_Test_Model(self):
        ...
        data_filtered = data[self.FEATURES]
        ...
        # Model Training
        #model = load_model('MVLSTM.h5')
        model = load_model(model_path+'\MVLSTM.h5')
...
#-----------------------------------------------------------------
        ...
        new_df = df_temp.filter(self.FEATURES)
